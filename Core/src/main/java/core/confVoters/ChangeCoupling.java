...
public class ChangeCoupling {
    ...
    public ChangeCoupling(HashMap<String, core.beans.Commit> map){
        this.map=map;
    }

    public ChangeCoupling(HashMap<String, core.beans.Commit> map, int upperBound) {
        this.map=map;
    ...
    private boolean inSameCommit(core.beans.Commit commit, String path1, String path2){
        int counter=0;
