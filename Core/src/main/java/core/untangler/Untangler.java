package core.untangler;


import core.beans.CommitChange;
import core.beans.Partition;
import core.beans.PartitionItem;
import core.beans.StagedCommit;
import core.confVoters.ChangeCoupling;
import core.confVoters.PackageDistance;
...
public class Untangler {
    ...
    private int longestPathSize(){
        ...
        Iterator<Map.Entry<String, core.beans.Commit>>it=map.entrySet().iterator();

        core.beans.Commit commit=it.next().getValue();
    ...
    private int longestPathCommit(core.beans.Commit c){
